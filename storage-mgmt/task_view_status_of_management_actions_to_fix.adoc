...
.Schritte
. Klicken Sie im linken Navigationsbereich auf *Management Actions*. Alternativ dazu klicken Sie image:../media/more_icon.gif["Weitere Symbole"]oben im Bereich *Management Actions* auf dem *Dashboard* und wählen die Ansicht aus, die Sie sehen möchten.
+
