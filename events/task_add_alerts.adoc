...
.. Klicken Sie auf *exclude*, und geben Sie *`xyz`* in das Feld *Name enthält* ein, und klicken Sie dann auf *Add*.
...
. Klicken Sie auf *actions*, und geben Sie *`sample@domain.com`* in das Feld Diese Benutzer benachrichtigen ein.
