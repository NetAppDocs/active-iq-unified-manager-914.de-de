...
. Speichern Sie die Ansicht mit einem bestimmten Namen, der das anzeigt, was die Ansicht zeigt, zum Beispiel "`Aggregate nearing full`", und klicken Sie auf das Häkchen (image:../media/blue_check.gif[""]) .
