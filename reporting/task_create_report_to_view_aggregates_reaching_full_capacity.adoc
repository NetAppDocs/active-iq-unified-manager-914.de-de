...
. Speichern Sie die Ansicht mit einem bestimmten Namen, der die Anzeige der Ansicht wiedergibt, z. B. „`Tage zur vollen Aggregatkapazität`“, und klicken Sie auf das Häkchen (image:../media/blue_check.gif[""]).
