...
+
Die Seite Volume Performance Explorer wird angezeigt. Oben auf der Seite, in der Ereigniszeitzeile, zeigt ein Änderungssymbol (image:../media/opm_change_icon.gif["Symbol „Ereignis ändern“"]) die Zeit an, zu der Unified Manager den Start der HA-Übernahme erkannt hat.
