...
Nachdem Sie auf *Filter anwenden* geklickt haben, schließt sich das Filterfenster, wendet Ihre Filter an und zeigt die Anzahl der angewendeten Filter an (image:../media/opm_filters_applied.gif[""]).
