...
Alle Objekte auf der Seite
 a| 
Das image:../media/select_dropdown_65_png.gif["Wählen Sie das Dropdown-Symbol aus"] Drop-down-Feld, und wählen Sie *Alle Objekte auf dieser Seite auswählen*.
...
Alle Objekte desselben Typs
 a| 
Das image:../media/select_dropdown_65_png.gif["Wählen Sie das Dropdown-Symbol aus"] Drop-down-Feld, und wählen Sie *Alle Objekte auswählen*.
