...
.. Geben Sie in das Feld Ereignisname enthält ein `*latency*`, und klicken Sie dann auf den Pfeil, um alle übereinstimmenden Ereignisse auszuwählen.
.. Geben Sie in das Feld Ereignisname enthält ein `*iops*`, und klicken Sie dann auf den Pfeil, um alle übereinstimmenden Ereignisse auszuwählen.
.. Geben Sie in das Feld Ereignisname enthält ein `*mbps*`, und klicken Sie dann auf den Pfeil, um alle übereinstimmenden Ereignisse auszuwählen.
