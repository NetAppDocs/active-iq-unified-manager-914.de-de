...
Ausgewähltes Objekt ausblenden
 a| 
Klicken Sie im Vergleichsfenster auf das Augensymbol des ausgewählten Objekts (image:../media/eye_icon.gif[""]). Die Objektdaten sind ausgeblendet, und das Augensymbol für das Objekt wird grau.
