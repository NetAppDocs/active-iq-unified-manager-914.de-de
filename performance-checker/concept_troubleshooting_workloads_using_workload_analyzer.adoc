...
* Klicken Sie auf einer beliebigen Seite zur Workload-Inventarisierung (Volume, LUN, Workload, NFS-Freigabe oder SMB/CIFS-Freigabe) auf das Symbol Mehr image:../media/more_icon.gif[""]und dann auf *Workload analysieren*
